...
$sql = 'SELECT * FROM tbl_matkul LEFT JOIN tbl_mahasiswa ON(tbl_mahasiswa.NIM = tbl_mahasiswa.NIM)';
$mat = mysqli_query($conn, $sql);

$sql = 'SELECT * FROM tbl_dosen WHERE Nama_Dosen=("")';
                        ...
                        <div id="content">
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                    <h1 class="h3 mb-0 text-gray-800">HALAMAN DOSEN</h1>
                                </div>
                                    ...
                                    <div class="col-xl-12 col-lg-7">
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                                <h6 class="m-0 font-weight-bold text-success text-center">HALAMAN DOSEN</h6>
                                            </div>
                                            <!-- Card Body -->

                                            <div class="card-body">
                                                <h2>Matakuliah Yang Di Ampu (Sudah Ditentukan!!)</h2>
